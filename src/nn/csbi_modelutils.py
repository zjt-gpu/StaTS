...
def normalization(channels, num_groups=32):
    ...
    return GroupNorm(num_groups, channels)
...
class Upsamplev2(nn.Module):
    def __init__(self, channels, use_conv, dims=2, output_size=None):
...
class AttentionBlock(nn.Module):
    ...
    def __init__(self, channels, num_heads=1, use_checkpoint=False, num_norm_groups=32):
        super().__init__()
        self.channels = channels
...
class ResBlock(TimestepBlock):
    ...
    def __init__(
        ...
        self.out_layers = nn.Sequential(
            normalization(self.out_channels, num_groups=num_norm_groups),
            SiLU(),
