...
def extract_schedule(a, t, x_shape):
    B, *_ = t.shape
    out = a.gather(1, t.view(B, 1))  # 每个样本拿到 a[b, t[b]]

    # 5. reshape 为 (B, 1, 1, ..., 1)，方便与 x_t 做广播
    expand_shape = (B,) + (1,) * (len(x_shape) - 1)  # 例如 (32, 1, 1)
    out = out.view(*expand_shape)
